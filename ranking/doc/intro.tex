...
\zhl{
Our previous research~\cite{zhuang:wsdm2015} noticed this specific type of annotation bias, 
and showed that in a binary classification task, annotations on about 35\% of positive items and 5\% of negative items might be biased.  
In this work, we focus more on debiasing technology.  
}
...
\begin{enumerate}
  ...
  \item \emph{Conducting experiments on a real-world crowdsourcing platform.}
        ...
        and still +15-17\% improvement if we tune the majority voting strategy based on a given training set.  
        }
