...
Crowdsourcing provides an inexpensive and efficient method to annotate data on a large scale for various machine learning tasks
...
In fact, from the workers' point of view,
...
Although judgments are likely to be independent, this way of work assignment is too costly to be practical.
...
Thus, overall these might be undesirable and misleading as it is inconsistent with the case when workers make independent judgments.
...
rarely pays attention to possible annotation error that might be introduced by grouping data items into batches.
