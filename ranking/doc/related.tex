...
we then introduce rank aggregation techniques as well as their application on crowdsourced ranking or rating.  
...
Directly applying their techniques (\eg~\cite{hunter:aos2004}) may not necessarily lead to better performance, 
