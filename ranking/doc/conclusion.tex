...
against the na\"{i}ve majority voting strategy, 
and +17\% improvement over a tuned majority voting based on the given training data set.  
In a real data set, our technique can also achieve up to +15\% improvement on $F_1$-score
