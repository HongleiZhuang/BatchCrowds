...
we first generate their predictive probability \agp{fix here if changed before} $\eta_i$ for each $x_i \in X$ 
...
We utilize a real world crowdsourcing data set for annotating comments\agp{do you want
to cite your previous paper?}.  
...
\begin{itemize}
  \item \emph{Majority Voting (MV)}.
        ...
        This aggregation strategy is often used in practice~\cite{sheng:kdd2008}.  %adopted by many crowdsourcing service.  
...
increasing the quantity of labels collected does not help. 
