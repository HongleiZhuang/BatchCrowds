...
Crowdsourcing is the de-facto standard for gathering annotated training data.
While in theory, 
...
in order to save the time and cost caused by overhead instructions or background.
