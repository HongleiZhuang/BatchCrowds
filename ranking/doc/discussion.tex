...
In rating estimation,%~\ie~a regression problem, 
...
\agp{Not sure why the last two sentences are needed. Simply say:
Suppose we asked workers to provide ratings on each data item, 
grouped into batches, and our goal is to identify the true rating
of each data item.}
...
\agp{there can be bias similar to the one introduced in this paper.}  
